...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class PropertyExtensions
    {
        ...
        /// <summary>
        ///     Returns true if <see cref="IsKey"/> or <see cref="IsForeignKey"/> returns true.
        /// </summary>
        /// <param name="property"> The property to check. </param>
        /// <returns> True if the property is part of a key or foreign key, otherwise false. </returns>
